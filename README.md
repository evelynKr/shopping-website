...
## 느낀점
- 저는 세미프로젝트하면서 이제까지 배웠던거 복습할 수 있는 시간이 되었습니다. 스스로가 어떤 부분을 정확히 몰랐는지 알게 되서, 이런 부족한 부분을 보완해야 겠다 파악할 수 있었습니다. 이번 세미 프로젝트가  첫 프로젝트여서 갈피를 못잡았는데, 어떻게 진행되는지 전체적인 흐름을 본 것 같았고 방향을 잡은것같아서 좋았습니다!
